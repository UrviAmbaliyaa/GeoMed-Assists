...
import 'package:geomed_assist/Admin_Panel/terms_condtion_add.dart';
                  ...
                  onPressed: () async {
                    ...
                    Navigator.of(context, rootNavigator: true).push(
                      CupertinoPageRoute<bool>(
                        ...
                        builder: (BuildContext context) => term_conditions_add(
                            edit: true,
                            conditions: doc.docs.length != 0
                                ? doc.docs[0]['terms_conditions']
                                : null,
                  ...
                  builder: (context, snapshot) {
                    return snapshot.connectionState ==
                        ...
                        ? snapshot.hasData && snapshot.data!.docs.length != 0
                            ? Text(snapshot.data!.docs[0]['terms_conditions'],
                                style: TextStyle(
